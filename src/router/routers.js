  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'auto-form',
        access: 1,
        meta: { icon: 'md-clipboard', title: '自动表单' },
      ...
      },
      {
        ...
        name: 'modal-form',
        access: 1,
        meta: { icon: 'md-albums', title: '模态框表单' },
    ...
    children: [
      {
        ...
        access: 1,
        meta: { icon: 'md-browsers', title: '水球' },
    ...
    children: [
      {
        ...
        name: 'video-mp4',
        access: 1,
        meta: { icon: 'md-browsers', title: '视频mp4' },
        component: () => import('@/view/test/video-mp4.vue')
      }
      /* {
                path: 'video-m3u8',
                name: 'video-m3u8',
                access: 1,
                meta: {icon: 'md-browsers', title: '视频m3u8'},
                component: () => import('@/view/test/video-m3u8.vue')
            } */
    ]
  }
  /* {
