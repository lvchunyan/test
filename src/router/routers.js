    ...
    children: [
      {
        ...
        name: 'baidu-map',
        access: 1,
        meta: { title: '百度地图', notCache: true, icon: 'ios-book' },
        component: () => import('@/view/amap/baidu-map')
      },
      {
        path: '/gaode-map',
        name: 'gaode-map',
        access: 1,
        meta: { title: '高德地图', notCache: true, icon: 'ios-book' },
        component: () => import('@/view/amap/gaode-map')
      }
    ]
  },
  {
