<template>
    <div>
        <Row>
            ...
            <Col span="12">
                <div id="sevenChart" :style="{width: '100%', height: '420px',}"></div>
            </Col>
            <Col span="12">
                <div id="eightChart" :style="{width: '100%', height: '420px',}"></div>
            </Col>
            <Col span="12">
                <div id="nineChart" :style="{width: '100%', height: '420px',}"></div>
            </Col>
            <Col span="12">
                <div id="tenChart" :style="{width: '100%', height: '420px',}"></div>
            </Col>
            <Col span="24">
                <div id="elevenChart" :style="{width: '100%', height: '520px',}"></div>
            </Col>
        </Row>
    </div>
</template>
...
import shangxi from 'echarts/map/json/province/shanxi1.json'
...
export default {
  ...
  methods: {
    ...
    getSevenChart () {
      ...
      echarts.registerMap('中国', zhongguo)
      echarts.extendsMap('sevenChart', {
    ...
    getElevenChart () {
      ...
      echarts.registerMap('xianyang3', chongqing)
      var convertData = function (data) {
        var res = []
        for (var i = 0; i < data.length; i++) {
          var geoCoord = geoCoordMap[data[i].name]
      ...
      elevenChart = echarts.init(document.getElementById('elevenChart'))
      elevenChart.setOption(this.optionXyMap01)
